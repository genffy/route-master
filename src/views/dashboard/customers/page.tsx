...
import { FileDownload as DownloadIcon, PlusOne as PlusIcon, Upload as UploadIcon } from '@mui/icons-material';
      ...
      <Stack direction="row" spacing={3}>
        <Stack spacing={1} sx={{ flex: '1 1 auto' }}>
          ...
          <Stack direction="row" spacing={1} sx={{ alignItems: 'center' }}>
            <Button color="inherit" startIcon={<UploadIcon fontSize="medium" />}>
              Import
            </Button>
            <Button color="inherit" startIcon={<DownloadIcon fontSize="medium" />}>
              Export
            </Button>
          </Stack>
        </Stack>
        <div>
          <Button startIcon={<PlusIcon fontSize="medium" />} variant="contained">
            Add
          </Button>
        </div>
      </Stack>
